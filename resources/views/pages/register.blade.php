...
<body class="min-h-screen bg-[#5C63B8] flex items-center justify-center px-4">
    ...
    <div class="bg-white rounded-3xl shadow-xl w-full max-w-2xl px-12 py-10">
        ...
        <p class="text-center text-sm text-gray-600">
            ...
            <a href="{{ route('login') }}" class="text-[#5C63B8] font-semibold hover:underline ml-1">Sign in</a>
        </p>
