...
<body class="min-h-screen bg-[#5C63B8] flex items-center justify-center px-4 py-10">
    ...
    <div id="pelamarLoginCard" class="bg-white rounded-3xl shadow-xl w-full max-w-lg px-12 py-10">
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="mb-4">
                <div class="flex items-center bg-[#DEE0F5]/40 rounded-full overflow-hidden">
                    <div class="w-12 h-12 bg-[#5C63B8] rounded-full flex items-center justify-center ml-1 flex-shrink-0">
            ...
            <div class="flex items-center justify-between mb-5 px-1">
                <label class="flex items-center gap-2 text-sm text-[#5C63B8] font-medium cursor-pointer">
                    <input type="checkbox" name="remember" class="w-4 h-4 rounded accent-[#5C63B8]">
                    Remember me
                </label>
                <a href="{{ route('password.request') }}" class="text-sm text-[#5C63B8] font-medium hover:text-[#454B8C] transition-colors">
                    Forgot Password?
                </a>
            </div>
        ...
        <a href="{{ route('auth.google') }}"
           class="flex items-center justify-center gap-2 w-full border border-gray-300 rounded-full py-3.5 text-sm text-gray-700 hover:bg-gray-50 transition-all mb-5">
        ...
        <p class="text-center text-sm text-gray-600 mb-2">
            ...
            <a href="{{ route('register') }}" class="text-[#5C63B8] font-semibold hover:underline ml-1">Sign up</a>
        </p>
